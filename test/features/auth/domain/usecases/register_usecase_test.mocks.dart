...
// in nepalink/test/features/auth/domain/usecases/register_usecase_test.dart.
...
import 'package:nepalink/features/auth/domain/entities/user_entity.dart' as _i6;
...
class MockIAuthRepository extends _i1.Mock implements _i3.IAuthRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, bool>> register(_i6.UserEntity? user) =>
      (super.noSuchMethod(
        Invocation.method(
          #register,
          [user],
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.UserEntity>> uploadProfileImage(
    String? userId,
    _i7.File? photo,
  ) =>
      (super.noSuchMethod(
